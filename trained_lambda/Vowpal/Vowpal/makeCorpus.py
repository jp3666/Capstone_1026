...
from twaggregate import twaggregate
import nltk
import numpy as np
import re
...
rawTweets, rawLabels, rejected = twaggregate("congress.csv", 1, 20000)
makeCorpus(rawTweets, rawLabels, saveLocal=False, corpusFormat='mm')
