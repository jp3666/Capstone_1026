...
def splitEdgePunct(inputText):
    inputText = EdgePunctLeft.sub(r"\1\2 \3", inputText)
    inputText = EdgePunctRight.sub(r"\1 \2\3", inputText)
    return inputText
...
# "foo   bar " => "foo bar"
def squeezeWhitespace(inputText):
    return Whitespace.sub(" ", inputText).strip()
